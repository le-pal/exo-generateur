...
export const CURRICULUM: Record<string, CurriculumBySubject> = {
  ...
  '5ème': {
    'Mathématiques': [
      ...
      { label: 'Priorités opératoires et parenthèses', context: "Organiser et effectuer un calcul en appliquant les règles de priorité (multiplication et division avant addition et soustraction, calcul des parenthèses en premier), y compris avec des nombres relatifs et des calculs imbriqués sur plusieurs niveaux de parenthèses." },
      { label: 'Puissances d\'un nombre', context: "Écrire et calculer le carré et le cube d'un nombre, utiliser et interpréter la notation avec exposant entier positif pour une puissance, et connaître les puissances de 10 usuelles." },
